...
export class AppClient extends BaseClient {
     ...
     * @return Success
     */
    generate(overrideExisting: boolean | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/epg/generate?";
        if (overrideExisting === null)
            throw new Error("The parameter 'overrideExisting' cannot be null.");
     ...
     * @return Success
     */
    preview(source: string | null | undefined, fillData: boolean | undefined): Promise<EpgChannelExtendedListAjaxResponse> {
    ...
    protected processPreview(response: Response): Promise<EpgChannelExtendedListAjaxResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    fromFile(fillData: boolean | undefined, formFile: FileParameter | null | undefined): Promise<EpgChannelExtendedListAjaxResponse> {
        let url_ = this.baseUrl + "/api/epg/preview/from-file?";
        if (fillData === null)
            throw new Error("The parameter 'fillData' cannot be null.");
        else if (fillData !== undefined)
            url_ += "fillData=" + encodeURIComponent("" + fillData) + "&";
    ...
    protected processFromFile(response: Response): Promise<EpgChannelExtendedListAjaxResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    preview2(fillData: boolean | undefined, playlist: FileParameter | null | undefined): Promise<IptvChannelExtendedListAjaxResponse> {
    ...
    protected processPreview2(response: Response): Promise<IptvChannelExtendedListAjaxResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    fromFile2(playlist: FileParameter | null | undefined): Promise<FileResponse> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processFromFile2(_response);
        });
    }

    protected processFromFile2(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class EpgChannelExtended implements IEpgChannelExtended {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.channelEpgId = _data["channelEpgId"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        data["channelEpgId"] = this.channelEpgId;
        data["logo"] = this.logo;
        data["url"] = this.url;
